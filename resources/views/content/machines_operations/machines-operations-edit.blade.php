      ...
      <div class="card-body">
        <form class="needs-validation" action="{{ route('machines-operations.update',$machinesOperations->id) }}" method="post"  novalidate>
            ...
            <div class="d-flex justify-content-start column-gap-2 mb-3 mt-4">
                ...
                <button type="button" class="btn btn-primary btn-icon square-pill dropdown-toggle hide-arrow" style="width: 25px;height:25px" id="advanceOptionBtn" data-bs-toggle="collapse" data-bs-target="#advanceOption" aria-expanded="false" aria-controls="advanceOption">
